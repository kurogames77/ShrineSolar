    ...
    <>
      ...
      <div className="min-h-screen bg-[#a8a8a8] flex flex-col">
        ...
        {isHome && (
          ...
          >
            <div className="w-full max-w-7xl mx-auto px-8 sm:px-16 lg:px-24 py-4 sm:py-6 flex items-center justify-between">
        ...
        {isHome && (
          ...
          >
            <div className="w-full max-w-7xl mx-auto px-8 sm:px-16 lg:px-24 flex flex-col items-center text-center">
              <h1
