    ...
    <div className="min-h-screen bg-[#a8a8a8] flex flex-col">
      ...
      {isHome && isShopOpen && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4" onClick={() => setIsShopOpen(false)}>
          <div className="bg-[#a8a8a8] border-4 border-gray-600 rounded-3xl w-full max-w-5xl min-h-[60vh] sm:min-h-[70vh] max-h-[90vh] flex flex-col shadow-2xl relative" onClick={(e) => e.stopPropagation()}>
            <button 
            ...
            <div className="overflow-y-auto flex-grow flex flex-col p-8 pt-16 sm:p-12 sm:pt-20">
