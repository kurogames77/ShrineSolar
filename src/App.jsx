  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#a8a8a8] flex flex-col">
          ...
          >
            <div className="flex items-center justify-center sm:justify-between w-full" style={{ paddingLeft: '40px', paddingRight: '40px', paddingTop: '20px', paddingBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
                <button onClick={() => navigate('/')} className="animate-fade-in text-white font-bold tracking-wide transition-colors hover:text-gray-200 text-xs sm:text-base" style={{ textShadow: '0 2px 10px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,0.8)', animationDelay: '0.1s' }}>Home</button>
                <button onClick={() => setIsShopOpen(true)} className="animate-fade-in text-white font-bold tracking-wide transition-colors hover:text-gray-200 text-xs sm:text-base" style={{ textShadow: '0 2px 10px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,0.8)', animationDelay: '0.2s' }}>Shop</button>
                <button onClick={() => navigate('/my-cart')} className="animate-fade-in text-white font-bold tracking-wide transition-colors hover:text-gray-200 text-xs sm:text-base" style={{ textShadow: '0 2px 10px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,0.8)', animationDelay: '0.3s' }}>My Carts</button>
                <button onClick={() => setIsInquiryOpen(true)} className="animate-fade-in text-white font-bold tracking-wide transition-colors hover:text-gray-200 text-xs sm:text-base" style={{ textShadow: '0 2px 10px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,0.8)', animationDelay: '0.4s' }}>Inquiry</button>
              </div>
            </div>
          </nav>
        )}
        ...
        {isHome && (
          <div className="block sm:hidden fixed z-40 w-full flex justify-center" style={{ top: '90px' }}>
            <img src="/apple-touch-icon.png" alt="Shrine Solar Icon" className="h-16 w-16 drop-shadow-2xl" style={{ filter: 'drop-shadow(0 4px 6px rgba(0,0,0,0.8))' }} />
          </div>
        )}
