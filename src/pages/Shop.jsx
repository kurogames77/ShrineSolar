            ...
            <div className="flex-shrink-0 bg-white" style={{ paddingLeft: '10px', paddingRight: '10px', paddingBottom: '10px', paddingTop: '10px' }}>
              <div className="w-full flex justify-center">
                <button
                  ...
                  className="w-full sm:w-[400px] h-16 sm:h-20 bg-amber-500 hover:bg-amber-600 text-white font-bold text-lg sm:text-xl rounded-2xl transition-colors shadow-lg flex items-center justify-center gap-3"
                >
