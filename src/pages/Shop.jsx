  ...
  return (
    <div className="w-full min-h-screen bg-[#eef2f7] flex flex-col items-center">
      ...
      <div className="w-full max-w-7xl flex justify-center items-center gap-4 px-4 mb-4 sm:mb-8">
        <div className="relative w-full max-w-[480px] bg-gray-100 rounded-2xl shadow-md p-1.5 transition-all duration-150 ease-in-out hover:scale-105 hover:shadow-lg">
        ...
        <button 
          className="flex items-center justify-center w-14 h-14 bg-gray-100 rounded-2xl shadow-md transition-all duration-150 ease-in-out hover:scale-105 hover:shadow-lg text-gray-600 focus:outline-none flex-shrink-0" 
          title="Filter"
        >
