...
export default function Battery() {
  ...
  return (
    <div className="w-full flex-grow flex flex-col pt-16 px-8 pb-8 items-center">
      ...
      {/* Main Content Modal */}
      <div className="bg-[#a8a8a8] border-4 border-gray-600 rounded-3xl w-full max-w-7xl p-10 my-8 shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full">
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div key={item} className="bg-[#909090] border-2 border-gray-500 rounded-3xl min-h-[350px] flex flex-col items-center p-6 shadow-lg hover:scale-105 transition-transform">
              ...
              <button className="w-40 py-3 bg-[#a8a8a8] border-2 border-gray-600 text-black font-bold text-lg rounded-full hover:bg-gray-300 transition-colors shadow-md flex-shrink-0">
                View
              </button>
            </div>
          ))}
