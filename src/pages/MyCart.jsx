                            ...
                            <div key={category} className="mb-5 sm:mb-7">
                                ...
                                <div className="flex flex-col gap-2.5 sm:gap-3">
                                    {items.map((item, idx) => {
                                        ...
                                        return (
                                            <div key={idx} className="bg-[#f8fafc] border border-[#e2e8f0] rounded-xl px-4 py-3 sm:px-5 sm:py-4 flex items-center justify-between hover:shadow-sm transition-shadow">
                                                ...
                                                <button
                                                    ...
                                                    className="w-8 h-8 sm:w-9 sm:h-9 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center transition-colors flex-shrink-0"
                                                    title="Remove"
                                                >
